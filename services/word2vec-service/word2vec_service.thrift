...
service Word2Vec
{
  ...
  /**
   * Returns list of possible answers to the analogy problem defined by word1, word2 and word3
   * @param string word1 - the first word
   * @param string word2 - the second word
   * @param string word3 - the thirdt word
   * @return list<ScoredString> - list of scored answers, ordered by decreasing score
   */
  list<ScoredString>    analogy( 1: string word1 , 2: string word2 , 3: string word3 )
   ...
   */
  double distance( 1: string word1 , 2: string word2 )
   ...
   */
   double cosine_similarity( 1: string word1 , 2: string word2 )
