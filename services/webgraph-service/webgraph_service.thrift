namespace java edu.columbia.cs.nlp.webgraph.server.thrift
namespace perl WebGraph
...
service WebGraphService
{
  ...
  /**
   * Returns list of incoming link (URL) ids given a target (URL) id 
   * @param long node_id - the target id
   * @param long max - the maximum number of nodes to return - 0 to return all registered nodes
   * @return list<i64> - list of linking (URL) ids
   */
   list<i64>    get_linking_nodes( 1: i64 node_id , 2: i64 max )
